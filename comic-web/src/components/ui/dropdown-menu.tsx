...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "text-text z-50 min-w-[8rem] overflow-hidden rounded-md border bg-background p-1 shadow-md",
